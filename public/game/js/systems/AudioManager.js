...
const TRACKS = {
  ...
  city: {
    bpm: 138,
    lead: [
      ['C5', 1], ['G4', 1], ['C5', 1], ['Db5', 1], ['C5', 1], ['G4', 1], ['Bb4', 1], ['C5', 1],
      ['F5', 1], ['E5', 1], ['C5', 1], ['G4', 1], ['Ab4', 2], ['G4', 2],
      ['C5', 1], ['G4', 1], ['C5', 1], ['Eb5', 1], ['F5', 1], ['Eb5', 1], ['C5', 1], ['Bb4', 1],
      ['G4', 2], ['Ab4', 2], ['C5', 2], ['-', 2],
    ],
    bass: [
      ['C2', 1], ['C2', 1], ['G1', 1], ['C2', 1], ['Ab1', 1], ['Ab1', 1], ['G1', 1], ['G1', 1],
      ['F2', 1], ['F2', 1], ['C2', 1], ['C2', 1], ['G1', 1], ['G1', 1], ['G1', 1], ['G1', 1],
    ],
    gain: 0.1,
  },
  campus: {
    bpm: 120,
    lead: [
      ['E5', 1], ['F5', 1], ['G5', 2], ['E5', 1], ['C5', 1], ['D5', 2],
      ['C5', 1], ['D5', 1], ['E5', 2], ['G4', 2], ['C5', 2],
      ['G5', 1], ['F5', 1], ['E5', 2], ['D5', 1], ['C5', 1], ['D5', 2],
      ['C5', 4], ['-', 2],
    ],
    bass: [
      ['C3', 2], ['E3', 2], ['F3', 2], ['G3', 2],
  ...
  estate: {
    bpm: 96,
    lead: [
      ['C4', 2], ['C4', 1], ['Eb4', 1], ['C4', 2], ['Bb3', 2],
      ['Ab3', 4], ['G3', 4],
      ['C4', 2], ['Eb4', 2], ['F4', 2], ['Eb4', 2],
      ['C4', 6], ['-', 2],
    ],
    bass: [
      ['C2', 2], ['C2', 2], ['C2', 2], ['C2', 2],
